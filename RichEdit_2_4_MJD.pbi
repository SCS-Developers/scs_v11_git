; File: RichEdit_2_4_MJD.pbi
; based on RichEdit_2_4.pbi, which is a version-based-name for RichEdit.pbi - see below for info
; INFO: refer to modifications from originals as marked 'MJD'
...
; Version 2.4, September 04, 2015
; fixed some API-Call that require pointer and no string
;======================================================================

; DeclareModule RichEdit : MJD
  
  #CFM_ALLCAPS = $80
  #CFM_ANIMATION = $40000
  #CFM_BACKCOLOR = $4000000
  #CFM_BOLD = $1
  CompilerIf Defined(CFM_CHARSET, #PB_Constant) = #False
    #CFM_CHARSET = $8000000
  CompilerEndIf
  #CFM_COLOR = $40000000
  #CFM_DISABLED = $2000
  ...
  #CFM_HIDDEN = $100
  #CFM_IMPRINT = $1000
  CompilerIf Defined(CFM_ITALIC, #PB_Constant) = #False
    #CFM_ITALIC = $2
  CompilerEndIf
  #CFM_KERNING = $100000
  #CFM_LCID = $2000000
  #CFM_LINK = $20
  CompilerIf Defined(CFM_OFFSET, #PB_Constant) = #False
    #CFM_OFFSET = $10000000
  CompilerEndIf
  #CFM_OUTLINE = $200
  #CFM_PROTECTED = $10
  ...
  #CFM_SMALLCAPS = $40
  #CFM_SPACING = $200000
  CompilerIf Defined(CFM_STRIKEOUT, #PB_Constant) = #False
    #CFM_STRIKEOUT = $8
  CompilerEndIf
  #CFM_STYLE = $80000
  ...
  CompilerIf Defined(CFE_BOLD, #PB_Constant) = #False
    #CFE_BOLD = #CFM_BOLD
  CompilerEndIf
  ...
  CompilerIf Defined(CFE_ITALIC, #PB_Constant) = #False
  ...
  CompilerIf Defined(CFE_STRIKEOUT, #PB_Constant) = #False
    #CFE_STRIKEOUT = $8
  CompilerEndIf
  #CFE_SUBSCRIPT = $10000
  ...
  CompilerIf Defined(ENM_LINK, #PB_Constant) = #False
    #ENM_LINK = $04000000
  CompilerEndIf
    ...
    *obj = AllocateMemory(SizeOf(RichEditClassTemplate))
    If *obj
      With *obj
        ...
        ; INFO: (MJD) use scsEditorGadget() instead of EditorGadget()
        ; \ID = EditorGadget(#PB_Any, X, Y, w, h)
        \ID = scsEditorGadget(X, Y, w, h)
        \hWnd = GadgetID(\ID)
        SetGadgetColor(\ID, #PB_Gadget_BackColor, #White)
        SetGadgetFont(\ID, FontID(LoadFont(#PB_Any, "Arial", 10)))
        SendMessage_(\hWnd, #EM_SETTEXTMODE, #TM_RICHTEXT, 0) ; Added 23May2023 11.10.0bd - required for PB 6.02 as advised by Fred in Forum topic "EditorGadget and RTF files in PB 6.02 Beta 1"
