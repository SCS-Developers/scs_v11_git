...
Global gsLanguageCode.s = "ZH" ; Chinese
XIncludeFile "scsLangZH.pbi"

Enumeration 1
  #SCS_LANG_DB_CREATE     ; use CREATE to create a completely new database for this language
  #SCS_LANG_DB_READ       ; use READ to read a translation database provided by the translator, so that an export file can be created and copied into scsLangZH.pbi
