; file: scs11dcd_code.pbi

; 'data clean' program to be run at the start of an uninstall of the DEMO version of SCS

; INFO: compile using scs11dcd_x64.pb and scs11dcd_x86.pb
...
Procedure doClean()
  ...
  ; OMIT FOR DEMO VERSION TO PREVENT USER UNINSTALLING THEN REINSTALLING AND GETTING ANOTHER 30 DAYS
