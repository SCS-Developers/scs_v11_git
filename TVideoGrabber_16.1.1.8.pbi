; File TVideoGrabber_16.1.1.8.pbi
; derived from TVideoGrabber.h

#SCS_TVG_DLL = "TVideoGrabber_16.1.1.8.dll"
...
Enumeration ;- TVideoRenderer
  ...
  #tvc_vr_None = 7
  #tvc_vr_madVR = 8
  #tvc_vr_DatasteadRealtimeRenderer = 9
EndEnumeration
...
Prototype.i pr_CanOpenURL_async (*TVGObject)
...
Prototype.i pr_SetFFmpegFilter (*TVGObject, FilterIndex.l, *FilterName, *Parameters)
...
Prototype   pr_ShowDebugWindow (*TVGObject, Fulllog.l)
...
Procedure openTVGLibrary()
  ...
  If gnTVGLibrary
    ...
    Global TVG_CanOpenURL_async.pr_CanOpenURL_async                                                                           = GetFunction(gnTVGLibrary, "_CanOpenURL_async")
    ...
    Global TVG_SetFFmpegFilter.pr_SetFFmpegFilter                                                                             = GetFunction(gnTVGLibrary, "_SetFFmpegFilter")
